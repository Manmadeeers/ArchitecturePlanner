...
const messages = {
  ru: {
    ...
    scenarios: {
      ...
      description: "Run what-if cases against your current questionnaire and compare deltas side by side.",
      run: "Run scenarios",
      running: "Running scenarios...",
      architecture: "Architecture",
      deployment: "Deployment",
      costDelta: "Monthly cost delta",
...
const valueLabels = {
  ...
  be: {
    ...
    authentication: "Аўтэнтыфікацыя",
    payments: "Плацяжы",
    "subscription-billing": "\u041f\u0430\u0434\u043f\u0456\u0441\u043a\u0456 \u0456 \u0431\u0456\u043b\u0456\u043d\u0433",
    "file-upload": "Загрузка файлаў",
    search: "Пошук",
    "analytics-dashboard": "\u0410\u043d\u0430\u043b\u0456\u0442\u044b\u043a\u0430 \u0456 \u0434\u0430\u0448\u0431\u043e\u0440\u0434\u044b",
    reporting: "\u0421\u043f\u0440\u0430\u0432\u0430\u0437\u0434\u0430\u0447\u044b",
    "team-collaboration": "\u041a\u0430\u043c\u0430\u043d\u0434\u043d\u0430\u044f \u0441\u0443\u043f\u0440\u0430\u0446\u0430",
    "third-party-integrations": "\u0406\u043d\u0442\u044d\u0433\u0440\u0430\u0446\u044b\u0456 \u0437 \u0437\u043d\u0435\u0448\u043d\u0456\u043c\u0456 \u0441\u044d\u0440\u0432\u0456\u0441\u0430\u043c\u0456",
    "workflow-automation": "\u0410\u045e\u0442\u0430\u043c\u0430\u0442\u044b\u0437\u0430\u0446\u044b\u044f \u043f\u0440\u0430\u0446\u044d\u0441\u0430\u045e",
    ...
    "layered-monolith": "Маналіт",
    microservices: "Мікрасэрвісы",
    "event-driven": "Падзейная архітэктура",
    monolith: "Маналіт",
...
const fixedTextTranslations = {
  ru: {
    ...
    "Layered Monolith": "Слоистый монолит",
    Microservices: "Микросервисы",
  ...
  be: {
    ...
    "Layered Monolith": "Слаісты маналіт",
    Microservices: "Мікрасэрвісы",
    "Event-Driven Services": "Падзейныя сэрвісы",
...
export function I18nProvider({ children }) {
  ...
  function getPlanSummary(plan) {
    return t("plan.summaryTemplate", {
      ...
      architectureStyle: getValueLabel(plan?.recommendation?.architectureStyle || "layered-monolith"),
